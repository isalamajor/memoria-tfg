...
Para la gestión de imágenes de perfil, se ha implementado una solución que combina la librería \textbf{Multer} para el procesamiento eficiente de archivos con \textbf{Cloudinary} como servicio de almacenamiento en la nube. Cloudinary es un servicio de gestión de recursos digitales que proporciona almacenamiento persistente, distribución a través de CDN y optimización automática de imágenes.
