...
\begin{itemize}
    ...
    \item Framer Motion: Biblioteca de animaciones para crear transiciones fluidas y experiencias interactivas.
    \item React Quill: Editor de texto enriquecido basado en Quill.js para la escritura de cartas.
    \item Axios: Cliente HTTP para comunicación con la API backend.
    \item React Leaflet: Biblioteca para integración de mapas interactivos.
\end{itemize}
...
\begin{itemize}
    \item \texttt{app/}: Directorio principal que contiene las páginas y rutas de la aplicación.
    ...
    \item \texttt{lib/}: Utilidades, tipos TypeScript y constantes.
