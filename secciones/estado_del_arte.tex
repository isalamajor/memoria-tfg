...
La estructura de una etiqueta o \textit{tag} HTML se compone de una etiqueta de apertura, el contenido, y una etiqueta de cierre:
    \begin{itemize}
        ...
        \item La etiqueta de cierre marca el fin de la etiqueta. Si la etiqueta carece de contenido, se puede prescindir de la etiqueta de cierra marcando la etiqueta de apertura con un \textit{slash} ("/"), es decir, se puede utilizar \textit{<tag/>} en vez de \textit{<tag></tag>}.
    \end{itemize}
...
La utilización de un framework de JavaScript para el desarrollo de una aplicación web es muy recomendable dadas las funcionalidades preprogramadas para agilizar las tareas de programación. Entre ellas: la modularización del código, la optimización del rendimiento, la integración de servicios, la manipulación de eventos, la creación de interfaces dinámicas, y el manejo del DOM (\textit{Document Objetc Model}), la interfaz de programación que permite crear, eliminar o modificar elementos de la página.
